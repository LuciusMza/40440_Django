...
from AppCoder.views import lista_estudiantes, lista_cursos
...
urlpatterns = [
    ...
    path("saludo-nombre/<nombre>/", saludar_a_usuario),
    path("plataforma/lista-estudiantes/", lista_estudiantes),
    path("plataforma/lista-cursos/", lista_cursos),
]
